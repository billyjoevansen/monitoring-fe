    ...
    return (
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
          ...
          <SummaryCard label="Tebus Lengkap" value={summary.status_penebusan.tebus_lengkap} color="green" />
          <SummaryCard label="Tebus Sebagian" value={summary.status_penebusan.tebus_sebagian} color="yellow" />
          <SummaryCard label="Tebus Melebihi" value={summary.status_penebusan.tebus_melebihi} color="red" />
          <SummaryCard label="Belum Menebus" value={summary.status_penebusan.belum_menebus} color="orange" />
